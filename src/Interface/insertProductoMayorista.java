...
public class insertProductoMayorista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfd_IDLote.setBackground(new java.awt.Color(0, 0, 0));
        tfd_IDLote.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        tfd_IDLote.setForeground(new java.awt.Color(153, 0, 0));
        ...
        getContentPane().add(btn_InsertOProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 950, 276, 63));
    ...
    private void btn_InsertOProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_InsertOProductoActionPerformed
        ...
        if (tfd_Descripcion.getText().equals("") || tfd_IDCategoria.getText().equals("") || tfd_IDLote.getText().equals("") || tfd_Nombre.getText().equals("") || tfd_PesoTotal.getText().equals("") || tfd_URLFoto.getText().equals("") || tfd_ValorUnidad.getText().equals("") || tfd_precioTotal.getText().equals("")) {
    ...
    private void btn_BuscarFotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarFotoActionPerformed
        ...
        JFileChooser fileChooser = new JFileChooser("C:\\Users\\Melvin\\Desktop\\RepositorioProyecto2Algoritmos\\src\\Imagenes");
